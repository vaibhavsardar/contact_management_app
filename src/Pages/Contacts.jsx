...
const Contacts = () => {
    ...
    return (
        <div className="justify-center pt-16 text-gray-50   p-4  w-full ">
            <div className="m-4">
                <button className="text-2xl px-4 py-2 tracking-wide text-white transition-colors duration-200 transform bg-gray-700 rounded-md hover:bg-gray-600 focus:outline-none focus:bg-gray-600">
            ...
            <div id="contact_list" className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                {
                    AllContacts.map((el) => {
                        return <div key={el.id} className="bg-gray-700 rounded-lg shadow-md m-4 p-4 text-white">
                            ...
                            <div className="flex justify-between my-2">
                                <Link to={`/contacts/edit/${el.id}`}>
                                    <button className="rounded p-2 bg-lime-400 text-black">
